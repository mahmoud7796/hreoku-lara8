...
######## Pages ##########
Route::get('/home', [VisitorsController::class,'home'])->name('home');
...
Route::group(['prefix' => 'home', 'middleware' => 'auth'], function(){
    ...
    Route::get('/multi-edit/{id}', [MultiController::class,'edit'])-> name('multi.edit');
    Route::post('/multi-update/{id}', [MultiController::class,'update'])-> name('multi.update');
    Route::get('/multi-delete/{id}', [MultiController::class,'delete'])-> name('multi.delete');
    ######## End Multi Images ######
